...
//    private GameController game;
    ...
    public void onUpdate() {
        ...
        if(gameController.getPlayer().getId() == getId() && gameController.getLastAction() instanceof EndTurnAction){

            if(this.getPosition().isRoom()){
                sendAction(new AccuseAction(this, randPersonCard, randRoomCard, randWeaponCard));
            }
        } else if (gameController.getPlayer().getId() == getId() && gameController.getLastAction() instanceof ShowCardsAction){
