            ...
            case SUGGEST:
                ...
                if (state.getAction().actionType == ActionType.STARTTURN || state.getAction().actionType == ActionType.MOVE || state.getAction().actionType == ActionType.TELEPORT) {
                    if (action.result){
                        ...
                        try {
                            System.out.println("[GameController.performAction] pulling player original position: "+((SuggestAction) action).getPlayer().getPosition() );
                            ...
                            System.out.println("[GameController.performAction] pulling player new position: "+((SuggestAction) action).getPlayer().getPosition() );
